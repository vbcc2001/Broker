 ...
 * 模块列表：
	...
	1、修改了 ajax 的源码，将	XMLHttpRequest 设置 withCredentials 属性的操作放在 open 方法之后。
	2、handler.proxy 事件处理函数的修改，当元素被移除时，不触发移除前绑定的事件处理函数
	3、touch.js X5 内核 swipe 事件不触发问题的修复
 */	
var Zepto = (function() {
  ...
  function add(element, events, fn, data, selector, delegator, capture){
    ...
    events.split(/\s/).forEach(function(event){
      ...
      handler.proxy = function(e){
        ...
        if(element.baseURI == null) return
        e.data = data
